...
object BinaryOperator extends Enumeration {
  ...
  val || : BinaryOperator.Value = Value("||")
  val ^ : BinaryOperator.Value = Value("^")
  val bitAnd : BinaryOperator.Value = Value("&")
  val % : BinaryOperator.Value = Value("%")
  val << : BinaryOperator.Value = Value("<<")
  val >> : BinaryOperator.Value = Value(">>")
}
...
abstract class ArithmeticExpr(val ae: arithexpr.arithmetic.ArithExpr) extends Expr
...
object ArithmeticExpr {
  def apply(ae: arithexpr.arithmetic.ArithExpr): ArithmeticExpr = DefaultImplementations.ArithmeticExpr(ae)
...
object DefaultImplementations {
  ...
  case class ArithmeticExpr(override val ae: arithexpr.arithmetic.ArithExpr) extends C.AST.ArithmeticExpr(ae) {
